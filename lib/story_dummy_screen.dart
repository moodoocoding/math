...
class _StoryDummyScreenState extends State<StoryDummyScreen> {
  ...
  static const List<_ChapterScene> _scenes = [
    _ChapterScene(
      speaker: '하우',
      line: '어? 벽에 걸려 있던 반짝별의 불빛들이 조금씩 흐려지더니... 꺼지기 시작했어!',
      characterAsset: 'assets/images/chr_how_worry.png',
    ),
    _ChapterScene(
      speaker: '플레이',
      line: '빛이 완전히 사라지기 전에 얼른 첫 번째 별 조각을 찾아야 해!',
      characterAsset: 'assets/images/chr_play_worry.png',
    ),
    _ChapterScene(
      speaker: '하우',
      line: '저기 봐! 벽에 은은한 빛 글씨가 나타났어. 첫 번째 별 조각이 이 방에 숨겨져 있나 봐!',
      characterAsset: 'assets/images/chr_how_left.png',
    ),
    _ChapterScene(
      speaker: '플레이',
      line: '첫 번째 별 조각이 담긴 상자야! 그런데 굳게 닫혀서 꼼짝도 안 해. 숨겨진 비밀을 밝혀내야 열릴 것 같아.',
