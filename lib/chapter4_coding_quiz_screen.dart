...
class Chapter4CodingQuizScreen extends StatefulWidget {
  ...
  @override
  State<Chapter4CodingQuizScreen> createState() =>
      _Chapter4CodingQuizScreenState();
}
...
class _Chapter4CodingQuizScreenState extends State<Chapter4CodingQuizScreen> {
  ...
  static const List<_CodingQuestion> _questions = [
    _CodingQuestion(
      question:
          '어떤 문제를 해결하기 위해 정해진 순서와 방법을 말하며,\n컴퓨터 프로그램이 작동하는 논리적 뼈대가 되는 개념은 무엇일까요?',
      correctAnswer: '알고리즘',
      choices: ['알고리즘', '인공지능', '코딩블록', '조건문'],
      explanation:
          '기원전 300년경 수학자 유클리드가 고안한 \'최대공약수 알고리즘\'은 인류 역사상 최초의 공식 알고리즘으로 기록되어 있습니다.',
    ),
    _CodingQuestion(
      question:
          '사람처럼 스스로 생각하고, 학습하고, 판단할 수 있도록\n똑똑하게 만들어진 컴퓨터 프로그램 기술을 무엇이라고 할까요?',
      correctAnswer: '인공지능',
      choices: ['인공지능', '알고리즘', '자율주행', '머신러닝'],
      explanation:
          '1997년 IBM의 인공지능 \'디프 블루\'가 세계 체스 챔피언을 최초로 꺾으며 인공지능의 시대를 전 세계에 선포했습니다.',
    ),
    _CodingQuestion(
      question:
          '텍스트 명령어를 직접 치지 않고, 블록을 쌓듯 쉽고 재미있게 이어 붙여서\n프로그래밍을 배울 수 있게 만든 도구는 무엇일까요?',
      correctAnswer: '코딩블록',
      choices: ['코딩블록', '조건문', '루프', '로봇'],
      explanation:
          '블록형 코딩은 미국 MIT 미디어랩에서 \'스크래치\'라는 이름으로 개발하였으며 오늘날 코딩 기초 교육의 세계 표준입니다.',
    ),
    _CodingQuestion(
      question:
          '사람이 운전대를 잡지 않아도 센서와 인공지능을 이용해 도로의 상황을 감지하고,\n스스로 목적지까지 안전하게 찾아가는 자동차 기술은 무엇일까요?',
      correctAnswer: '자율주행',
      choices: ['자율주행', '인공지능', '머신러닝', '페이스로봇'],
      explanation:
          '라이다(LiDAR), 레이다, 고성능 카메라 등 첨단 센서들이 매초 1GB가 넘는 도로 데이터를 수집하여 안전한 운행을 제어합니다.',
    ),
    _CodingQuestion(
      question:
          '컴퓨터에 정답을 직접 알려주는 대신, 엄청나게 많은 데이터를 입력하여\n컴퓨터가 스스로 패턴을 학습하고 똑똑해지도록 만드는 기술은 무엇일까요?',
      correctAnswer: '머신러닝',
      choices: ['머신러닝', '인공지능', '조건문', '알고리즘'],
      explanation:
          '바둑 두는 인공지능 \'알파고\'도 기보 수백만 개와 스스로 수억 번의 시뮬레이션을 반복 학습하는 머신러닝의 결과물입니다.',
    ),
    _CodingQuestion(
      question:
          '컴퓨터가 명령을 실행할 때, \'만약 ~라면\'이라는 규칙을 정해서\n주어진 조건의 참과 거짓에 따라 다르게 작동하도록 만드는 코딩 명령어는 무엇일까요?',
      correctAnswer: '조건문',
      choices: ['조건문', '루프', '코딩블록', '머신러닝'],
      explanation:
          '게임 캐릭터가 장애물에 부딪히면 생명력이 깎이거나, 온도가 높아지면 에어컨이 작동하는 등 스마트 제어의 핵심 요소입니다.',
    ),
    _CodingQuestion(
      question:
          '코딩을 할 때 동일하거나 비슷한 동작을 여러 번 타이핑하지 않고,\n정해진 횟수나 조건 동안 계속 반복하여 움직이게 만드는 명령어는 무엇일까요?',
      correctAnswer: '루프',
      choices: ['루프', '조건문', '코딩블록', '알고리즘'],
      explanation:
          '1초에 수십억 번의 연산이 가능한 컴퓨터는 단 몇 줄의 루프 코딩만으로 수천만 개의 복잡한 연산을 순식간에 끝마칠 수 있습니다.',
    ),
    _CodingQuestion(
      question:
          '단순한 기계를 넘어 사람의 다양한 표정과 감정을 카메라로 인식하고,\n얼굴 근육 모터를 조절해 사람처럼 웃거나 울며 감정을 나누는 로봇은 무엇일까요?',
      correctAnswer: '페이스로봇',
      choices: ['페이스로봇', '로봇', '인공지능', '자율주행'],
      explanation:
          '인간의 피부 질감을 모방한 특수 실리콘과 얼굴 내부의 모터 수십 개를 정밀 제어하여 미소, 찡그림 등 100가지 표정을 만듭니다.',
    ),
  ];
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                '벽에 떠오른 코딩 단서들이 글자판으로 숨어들었어요.\n이제 숨은 낱말을 찾아 길을 이어 보세요.',
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontSize: 22,
