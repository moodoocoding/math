...
class Chapter2Story3Screen extends StatefulWidget {
  const Chapter2Story3Screen({super.key});

  @override
  State<Chapter2Story3Screen> createState() => _Chapter2Story3ScreenState();
}

class _Chapter2Story3ScreenState extends State<Chapter2Story3Screen> {
  @override
  void initState() {
    super.initState();
